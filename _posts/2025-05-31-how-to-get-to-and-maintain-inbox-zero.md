...
6. **Remove all social media notification emails** Keep social media out of your email -- these megacorps have people with PHD's studying addiction working for them to trigger your response. You will remember to check instagram, I'm sure. Never get an email from social media, if it arrives send it to the spam folder immediately.
